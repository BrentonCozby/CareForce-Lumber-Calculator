...
(function _schematics() {
    ...
    var CutMaker = function CutMaker(quant, thick, wide, long, angle_left, angle_right) {
        return {
            "quant": quant,
            "thick": thick,
            "wide": wide,
    ...
    var list = {
        "Benches": {
            "Backed Bench (2' x 6')": {
                ...
                cuts: [CutMaker(7, 2, 6, 60), CutMaker(8, 2, 6, 17), CutMaker(2, 2, 6, 35, 10, 0), CutMaker(2, 2, 6, 72)]
            },
            "Backed Bench with Armrest": {
                cut_quant: 7,
                image: "http://i.imgur.com/ufMtPF3.png",
                cuts: [CutMaker(8, 2, 4, 72), CutMaker(1, 2, 4, 60), CutMaker(2, 2, 4, 36.5), CutMaker(2, 2, 4, 21), CutMaker(4, 2, 4, 19.5), CutMaker(6, 2, 4, 16.5), CutMaker(2, 2, 4, 14)]
            },
            "Concreted Simple Bench": {
                cut_quant: 3,
                image: "http://i.imgur.com/ilZCQuO.png",
                cuts: [CutMaker(1, 2, 12, 72), CutMaker(3, 4, 4, 36), CutMaker(2, 2, 4, 66)]
            },
            "Backless Bench": {
                cut_quant: 2,
            ...
            "Backless Bench (6')": {
                ...
                cuts: [CutMaker(3, 2, 6, 72), CutMaker(4, 2, 6, 18.5), CutMaker(4, 2, 6, 17), CutMaker(4, 2, 4, 21, 45, -45), CutMaker(2, 2, 4, 15.5)]
            },
            "Mural Bench": {
                cut_quant: 4,
                image: "http://i.imgur.com/M23sCpo.png",
                cuts: [CutMaker(7, 2, 6, 60), CutMaker(8, 2, 6, 17), CutMaker(2, 2, 6, 35, 10), CutMaker(1, 2, 12, 72)]
            },
            "Children's Bench": {
                cut_quant: 4,
                image: "http://i.imgur.com/PQfP7Su.png",
                cuts: [CutMaker(2, 2, 4, 72), CutMaker(7, 2, 4, 60), CutMaker(9, 2, 4, 10.75), CutMaker(2, 2, 4, 22, 10)]
            },
            "Children's Mural Bench": {
                cut_quant: 4,
                image: "http://i.imgur.com/8l6mEIv.png",
                cuts: [CutMaker(7, 2, 4, 60), CutMaker(9, 2, 4, 10.75), CutMaker(2, 2, 4, 22, 10), CutMaker(1, 2, 8, 72)]
            },
            "Double Planter Bench": {
                cut_quant: 9,
                image: "http://i.imgur.com/G3Icibn.png",
                cuts: [CutMaker(26, 2, 4, 22.5), CutMaker(12, 2, 4, 21), CutMaker(8, 2, 4, 17), CutMaker(4, 2, 4, 14), CutMaker(8, 2, 4, 24, 45, 45), CutMaker(1, 2, 4, 96), CutMaker(1, 2, 4, 93), CutMaker(5, 2, 4, 45), CutMaker(14, 2, 4, 21)]
            },
            "Single Planter Bench": {
                cut_quant: 11,
                image: "http://i.imgur.com/TjcO04e.png",
                cuts: [CutMaker(1, 2, 4, 73.5), CutMaker(1, 2, 4, 72), CutMaker(2, 2, 4, 46), CutMaker(4, 2, 4, 24, 45, -45), CutMaker(3, 2, 4, 24), CutMaker(13, 2, 4, 22.5), CutMaker(23, 2, 4, 21), CutMaker(4, 2, 4, 17), CutMaker(2, 2, 4, 15), CutMaker(2, 2, 4, 14), CutMaker(2, 2, 4, 13.5)]
            }
        },
        "Tables": {
            "Picnic Table": {
                ...
                cuts: [CutMaker(2, 2, 6, 66, 38, 38), CutMaker(4, 2, 6, 39.5, 38, 38), CutMaker(4, 2, 4, 34.25, 38, 38), CutMaker(2, 2, 4, 32, 26, -26), CutMaker(10, 2, 6, 96)]
            },
            "Picnic Table (3 leg)": {
                cut_quant: 5,
                image: "http://i.imgur.com/B0H0jBA.png",
                cuts: [CutMaker(3, 2, 6, 66, 38, -38), CutMaker(6, 2, 6, 39.5, 38, 38), CutMaker(5, 2, 4, 34.25, 38, -38), CutMaker(2, 2, 4, 32, 26, 26), CutMaker(10, 2, 6, 96)]
            },
            "Toddler Picnic Table": {
                cut_quant: 6,
                image: "http://i.imgur.com/1BzZFwm.png",
                cuts: [CutMaker(2, 2, 6, 64, 45, -45), CutMaker(9, 2, 6, 60), CutMaker(1, 2, 6, 45), CutMaker(4, 2, 6, 28, 38, 38), CutMaker(2, 2, 4, 29.5, 45, -45), CutMaker(1, 2, 4, 29.5)]
            }
        },
        "Garden": {
            "Planter Box": {
            ...
            "Two Tier Planter": {
                ...
                cuts: [CutMaker(10, 4, 4, 96), CutMaker(2, 4, 4, 92.5), CutMaker(8, 4, 4, 48)]
            },
            "Garden Bed (3' x 4')": {
                cut_quant: 5,
                image: "http://i.imgur.com/s1QJbEk.png",
                cuts: [CutMaker(2, 2, 6, 36, 45, -45), CutMaker(2, 2, 6, 48, 45, -45), CutMaker(4, 2, 8, 34.5), CutMaker(4, 2, 8, 46.5), CutMaker(4, 4, 4, 15)]
            },
            "Garden Bed (4' x 8')": {
                cut_quant: 5,
                image: "http://i.imgur.com/ojZ5gSQ.png",
                cuts: [CutMaker(2, 2, 6, 96, 45, -45), CutMaker(2, 2, 6, 48, 45, -45), CutMaker(4, 2, 8, 94.5), CutMaker(4, 2, 8, 46.5), CutMaker(6, 4, 4, 15)]
            },
            "Victory Garden Bed (4' x 8')": {
                cut_quant: 6,
                image: "http://i.imgur.com/sBxZ7VD.png",
                cuts: [CutMaker(5, 2, 4, 46), CutMaker(2, 2, 6, 48, 45, -45), CutMaker(2, 2, 6, 96, 45, -45), CutMaker(4, 2, 8, 46.5), CutMaker(4, 2, 8, 94.5), CutMaker(6, 4, 4, 15), CutMaker(1, 0.5, 48, 96)]
            },
            "Garden Box (24\" x 6')": {
                cut_quant: 5,
                image: "http://i.imgur.com/NzpKd0M.png",
                cuts: [CutMaker(2, 2, 4, 72, 45, -45), CutMaker(12, 2, 4, 70.5), CutMaker(2, 2, 4, 24, 45, -45), CutMaker(12, 2, 4, 22.5), CutMaker(4, 2, 4, 21)]
            },
            "Garden Box with Wheels": {
                cut_quant: 4,
                image: "http://i.imgur.com/PjUjxEw.png",
                cuts: [CutMaker(12, 2, 4, 22.5), CutMaker(12, 2, 4, 34.5), CutMaker(9, 1, 4, 24), CutMaker(4, 1, 4, 21)],
                specials: [SpecialMaker("Swivel Casters", 4, 3.67, "http://www.homedepot.com/p/Shepherd-2-1-2-in-Polypropylene-Swivel-Plate-Caster-with-175-lb-Load-Rating-9393/100212297"), SpecialMaker("1&frasl;8\" Fender Washers", 16, 1.18, "http://www.homedepot.com/p/Everbilt-1-8-in-x-1-in-Stainless-Steel-Fender-Washer-3-Piece-815841/204284499?MERCH=REC-_-SearchPLPHorizontal1_rr-_-NA-_-204284499-_-N")]
            }
        },
        "Outdoor Classroom": {
            "Stage": {
                ...
                cuts: [CutMaker(2, 2, 6, 96), CutMaker(8, 2, 6, 93), CutMaker(17, 1.25, 6, 96), CutMaker(8, 4, 4, 27)]
            },
            "Ramp": {
                cut_quant: 3,
                image: "http://i.imgur.com/jjIoS9u.png",
                cuts: [CutMaker(2, 2, 4, 48), CutMaker(4, 2, 4, 93), CutMaker(18, 1.25, 6, 48)]
            },
            "Podium": {
                cut_quant: 5,
                image: "http://i.imgur.com/1mPKK82.png",
                cuts: [CutMaker(1, 2, 12, 18), CutMaker(1, 2, 12, 4), CutMaker(1, 4, 4, 48, 45), CutMaker(2, 2, 4, 10.5), CutMaker(2, 2, 4, 3.5)]
            }
        },
        "Exercise": {
            "Chin-up Bars": {
                ...
                specials: [SpecialMaker("1\" x 4' Galvanized Steel Pipe", 2), SpecialMaker("1\" Galvanized Pipe Cap", 4, 3.35, "http://www.homedepot.com/p/LDR-Industries-1-in-Galvanized-Iron-Cap-311-CA-1/100575690"), SpecialMaker("80lb Concrete Bag", 3, 4.15, "http://www.homedepot.com/p/SAKRETE-80-lb-Gray-Concrete-Mix-65200390/100350291"), SpecialMaker("Marine Strength Epoxy", 1, 5.77, "http://www.homedepot.com/p/Loctite-0-85-fl-oz-Marine-Epoxy-1919324/205361752")]
            },
            "Push-up Bars": {
                cut_quant: 1,
                image: "http://i.imgur.com/fEtV5Bo.png",
                cuts: [CutMaker(2, 4, 4, 24)],
                specials: [SpecialMaker("1\" x 4' Galvanized Steel Pipe", 1), SpecialMaker("1\" Galvanized Pipe Cap", 2, 3.35, "http://www.homedepot.com/p/LDR-Industries-1-in-Galvanized-Iron-Cap-311-CA-1/100575690"), SpecialMaker("80lb Concrete Bag", 2, 4.15, "http://www.homedepot.com/p/SAKRETE-80-lb-Gray-Concrete-Mix-65200390/100350291"), SpecialMaker("Marine Strength Epoxy", 1, 5.77, "http://www.homedepot.com/p/Loctite-0-85-fl-oz-Marine-Epoxy-1919324/205361752")]
            },
            "Sit-up Bench": {
                cut_quant: 2,
                image: "http://i.imgur.com/IMdFcCZ.png",
                cuts: [CutMaker(10, 4, 4, 96), CutMaker(4, 4, 4, 48)],
                specials: [SpecialMaker("1\" x 4' Galvanized Steel Pipe", 3), SpecialMaker("1\" Galvanized Pipe Cap", 6, 3.35, "http://www.homedepot.com/p/LDR-Industries-1-in-Galvanized-Iron-Cap-311-CA-1/100575690"), SpecialMaker("80lb Concrete Bag", 8, 3.30, "http://www.homedepot.com/p/SAKRETE-60-lb-Gray-Concrete-Mix-65200940/100321247"), SpecialMaker("Marine Strength Epoxy", 1, 5.77, "http://www.homedepot.com/p/Loctite-0-85-fl-oz-Marine-Epoxy-1919324/205361752")]
            }
        },
        "Misc": {
            "Bike Rack": {
                ...
                cuts: [CutMaker(2, 4, 4, 48), CutMaker(8, 2, 4, 34.5), CutMaker(1, 2, 4, 56), CutMaker(1, 2, 4, 63)]
            },
            "Dolly": {
                cut_quant: 2,
                image: "http://i.imgur.com/pcKJXOo.png",
                cuts: [CutMaker(4, 2, 4, 24), CutMaker(2, 2, 4, 60)],
                specials: [SpecialMaker("Swivel Caster", 4, 3.67, "http://www.homedepot.com/p/Shepherd-2-1-2-in-Polypropylene-Swivel-Plate-Caster-with-175-lb-Load-Rating-9393/100212297"), SpecialMaker("1&frasl;8\" Fender Washers", 16, 1.18, "http://www.homedepot.com/p/Everbilt-1-8-in-x-1-in-Stainless-Steel-Fender-Washer-3-Piece-815841/204284499")]
            },
            "Entrance Sign": {
                cut_quant: 6,
                image: "http://i.imgur.com/KLXIEKX.png",
                cuts: [CutMaker(3, 4, 4, 90), CutMaker(1, 2, 8, 99), CutMaker(2, 2, 8, 48), CutMaker(2, 2, 4, 42.75), CutMaker(1, 0.5, 48, 96), CutMaker(1, 0.375, 48, 96)],
                specials: [SpecialMaker("60lbs Concrete Bag", 3, 3.30, "http://www.homedepot.com/p/SAKRETE-60-lb-Gray-Concrete-Mix-65200940/100321247")]
            }
        }
    };
...
}, LumberMaker("2\" x 4\" x 10'", 2, 4, 120, 5.47, "http://www.homedepot.com/p/WeatherShield-2-in-x-4-in-x-10-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-253920/206967803"), LumberMaker("2\" x 4\" x 12'", 2, 4, 144, 6.87, "http://www.homedepot.com/p/WeatherShield-2-in-x-4-in-x-12-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-253920/206967813"), LumberMaker("2\" x 6\" x 8'", 2, 6, 96, 6.57, "http://www.homedepot.com/p/WeatherShield-2-in-x-6-in-x-8-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-253921/206967808"), LumberMaker("2\" x 6\" x 10'", 2, 6, 120, 7.97, "http://www.homedepot.com/p/WeatherShield-2-in-x-6-in-x-10-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-253921/206967800"), LumberMaker("2\" x 6\" x 12'", 2, 6, 144, 9.37, "http://www.homedepot.com/p/WeatherShield-2-in-x-6-in-x-12-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-253921/206967802"), LumberMaker("2\" x 8\" x 8'", 2, 8, 96, 8.57, "http://www.homedepot.com/p/2-in-x-8-in-x-8-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-107523/206937455"), LumberMaker("2\" x 8\" x 10'", 2, 8, 120, 10.27, "http://www.homedepot.com/p/2-in-x-8-in-x-10-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-107523/206937440"), LumberMaker("2\" x 8\" x 12'", 2, 8, 144, 12.57, "http://www.homedepot.com/p/2-in-x-8-in-x-12-ft-2-Prime-Ground-Contact-Pressure-Treated-Lumber-107523/206937453"), LumberMaker("2\" x 12\" x 8'", 2, 12, 96, 17.27, "http://www.homedepot.com/p/2-in-x-12-in-x-8-ft-2-Prime-or-Better-Ground-Contact-Pressure-Treated-Lumber-112851/206964340"), LumberMaker("2\" x 12\" x 10'", 2, 12, 120, 20.57, "http://www.homedepot.com/p/2-in-x-12-in-x-10-ft-2-Prime-or-Better-Ground-Contact-Pressure-Treated-Lumber-112851/206964329"), LumberMaker("2\" x 12\" x 12'", 2, 12, 144, 24.57, "http://www.homedepot.com/p/2-in-x-12-in-x-12-ft-2-Prime-or-Better-Ground-Contact-Pressure-Treated-Lumber-112851/206964330"), LumberMaker("4\" x 4\" x 8'", 4, 4, 96, 6.97, "http://www.homedepot.com/p/Pressure-Treated-Timber-2-Southern-Yellow-Pine-Common-4-in-x-4-in-x-8-ft-Actual-3-56-in-x-3-56-in-x-96-in-194354/205220341"), LumberMaker("4\" x 4\" x 10'", 4, 4, 120, 11.87, "http://www.homedepot.com/p/4-in-x-4-in-x-10-ft-2-Pressure-Treated-Timber-4220254/100025396"), LumberMaker("4\" x 4\" x 12'", 4, 4, 144, 13.97, "http://www.homedepot.com/p/4-in-x-4-in-x-12-ft-2-Pressure-Treated-Timber-4230254/100073070"), LumberMaker("&frac12;\" x 4' x 8'", 0.5, 48, 96, 25.57, "http://www.homedepot.com/p/1-2-in-x-4-ft-x-8-ft-CDX-Ground-Contact-Pressure-Treated-Plywood-131876/206970940"), LumberMaker("5&frasl;4\" x 6\" x 6'", 1.25, 6, 72, 4.47, "http://www.homedepot.com/p/WeatherShield-5-4-in-x-6-in-x-6-ft-Ground-Contact-Pressure-Treated-Premium-Pine-Decking-Board-253944/206967717"), LumberMaker("5&frasl;4\" x 6\" x 8'", 1.25, 6, 96, 4.37, "http://www.homedepot.com/p/WeatherShield-5-4-in-x-6-in-x-8-ft-Standard-Ground-Contact-Pressure-Treated-Pine-Decking-Board-253919/206968441"), LumberMaker("5&frasl;4\" x 6\" x 10'", 1.25, 6, 120, 6.97, "http://www.homedepot.com/p/WeatherShield-5-4-in-x-6-in-x-10-ft-Standard-Ground-Contact-Pressure-Treated-Pine-Decking-Board-253919/206968438"), LumberMaker("5&frasl;4\" x 6\" x 12'", 1.25, 6, 144, 7.97, "http://www.homedepot.com/p/WeatherShield-5-4-in-x-6-in-x-12-ft-Standard-Ground-Contact-Pressure-Treated-Pine-Decking-Board-253919/206968439"), LumberMaker("&frac12;\" x 4' x 8'", 0.5, 48, 96, 25.57, "http://www.homedepot.com/p/1-2-in-x-4-ft-x-8-ft-CDX-Ground-Contact-Pressure-Treated-Plywood-131876/206970940"), LumberMaker("3&frasl;8\" x 4' x 8'", 0.375, 48, 96, 17.53, "http://www.homedepot.com/p/11-32-in-or-3-8-in-x-4-ft-x-8-ft-BC-Sanded-Pine-Plywood-166022/100094072"), LumberMaker("1&frasl;4\" x 4' x 8'", 0.25, 48, 96, 9.99, "http://www.homedepot.com/p/Utility-Panel-Common-1-8-In-x-4-Ft-x-8-Ft-Actual-0-106-in-x-48-in-x-96-in-833096/100535208"), LumberMaker("1\" x 12\" x 8'", 1, 12, 96, 16.98, "http://www.homedepot.com/p/1-in-x-12-in-x-8-ft-Premium-Kiln-Dried-Square-Edge-Whitewood-Common-Board-458538/100055946"), LumberMaker("1\" x 3\" x 8'", 1, 3, 96, 2.57, "http://www.homedepot.com/p/WeatherShield-1-in-x-3-in-x-8-ft-Pressure-Treated-Board-481861/100057569"), LumberMaker("1\" x 4\" x 8'", 1, 4, 96, 3.97, "http://www.homedepot.com/p/WeatherShield-1-in-x-4-in-x-8-ft-Ground-Contact-Pressure-Treated-Board-253915/206973928"), LumberMaker("1\" x 4\" x 10'", 1, 4, 120, 4.97, "http://www.homedepot.com/p/WeatherShield-1-in-x-4-in-x-10-ft-Ground-Contact-Pressure-Treated-Board-253915/206971108?keyword=1x4x10+pressure+treated"), LumberMaker("1\" x 4\" x 12'", 1, 4, 144, 5.87, "http://www.homedepot.com/p/WeatherShield-1-in-x-4-in-x-12-ft-Ground-Contact-Pressure-Treated-Board-253915/206973905")];
...
function getPrices() {
    var oldLumber = localStorage.lumber ? JSON.parse(localStorage.lumber) : lumber;

    var newLumber = oldLumber.map(function (item, i) {
        return getOnePrice(item.url).then(function (price) {
...
var _lumber = __webpack_require__(116);

var g = __webpack_require__(45);
var schematics = __webpack_require__(86);
...
function _createArrayOfCutsData(schematic, inputQuant) {
    var lumber = localStorage.lumber ? JSON.parse(localStorage.lumber) : _lumber.lumber;
...
function _sortDataByBeamName(lumberOrderCopy) {
    ...
    var beamNames = lumberOrderCopy.map(function (beam) {
        return beam.beamName;
    }).sort();
    for (var i = 0, beamNamesLength = beamNames.length; i < beamNamesLength; i++) {
        for (var j = 0, lumberOrderLength = lumberOrderCopy.length; j < lumberOrderLength; j++) {
...
var schematics = __webpack_require__(86);
var decimalRound = __webpack_require__(303);
var optimize = __webpack_require__(117);
var form = __webpack_require__(304);
var menu = __webpack_require__(307);

var setup = {
    init: function init() {
        getPrices().then(function (newLumber) {
...
(function _form() {
    ...
    var cutList = __webpack_require__(306);
    ...
    module.exports.init = function () {
        select.init();prevImage.init();calcButton.init();
    };
